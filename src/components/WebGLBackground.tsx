...
function FluidPlane() {
  ...
  useFrame(({ clock }) => {
    ...
    // Beacon radius — read from global Framer Motion value, write to shader.
    // Only active in void theme; day mode naturally ignores it in the shader.
    mat.uniforms.uBeaconRadius.value = beaconLightValue.get();
